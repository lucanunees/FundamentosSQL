/*
    	=== INNER JOIN, LeftJOIN, FULL JOIN, UNION, Group By, Having ===
    ...
    ,[Categoria].[Nome]
        FROM [Curso]
            INNER JOIN [Categoria] --   <--- Coloco a tabela que eu quero juntar as informações, ou seja, vou trazer tudo que tem na tabela curso que é relacionado com a tabela categoria.
                ON [Curso].[CategoriaID] = [Categoria].[ID]  --  <--- No "ON" é o campo que eu quero trazer da tabela curso comparando com a de categoria.   
